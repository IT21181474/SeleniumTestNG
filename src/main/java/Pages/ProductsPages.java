...
//    public static boolean formalShoesVerifyTitle() {
//        String expectedTitleFS = "Formal Shoes";
//        String actualTitleFS = driver.findElement(By.xpath(formalShoesXpath)).getText().trim();
//        return actualTitleFS.equals(expectedTitleFS);
//    }
    public static void formalShoesVerifyTitle(){
        String expectedTitleFS = "Formal Shoes";
...
//    public static boolean sportsShoesVerifyTitle() {
//        String expectedTitleSS = "Sports Shoes";
//        String actualTitleSS = driver.findElement(By.xpath(sportsShoesXpath)).getText().trim();
//        return actualTitleSS.equals(expectedTitleSS);
//    }

    public static void sportsShoesVerifyTitle(){
        String expectedTitleSS = "Sports Shoes";
...
//    public static boolean sneakersVerifyTitle() {
...
//    public static boolean formalShoesFirstShoeVerify() {
//        WebElement dropdown = driver.findElement(By.xpath(formalShoesDropdownXpath));
//        dropdown.click();
//
//        String expectedFirstFormalShoe = "Classic Cheltenham";
//        WebElement firstShoe = driver.findElement(By.xpath(formalShoesFirstShowName));
//
//        return firstShoe.getText().trim().equals(expectedFirstFormalShoe);
//    }
...
//    public static boolean sportsShoesFirstShoeVerify() {
//        WebElement dropdown = driver.findElement(By.xpath(sportsShoesDropdownXpath));
//        dropdown.click();
//
//        String expectedFirstSportShoe = "Ultimate";
//        WebElement firstShoe = driver.findElement(By.xpath(sportsShoesFirstShowName));
//
//        return firstShoe.getText().trim().equals(expectedFirstSportShoe);
//    }
